-- Migration untuk fitur Class Schedule (Jadwal Pelajaran) - Production
-- Jalankan script ini di Supabase SQL Editor atau database production Anda

-- Buat enum type untuk day of week (jika belum ada)
DO $$ BEGIN
...
-- Buat tabel class_schedules (jika belum ada)
...
-- Buat index untuk performa (jika belum ada)
